<template>
            ...
            <div class="right-two">
              <span>
                <el-tabs v-model="activeName" @tab-click="handleClick">
                  <el-tab-pane label="所有评估" name="first">
                    <div style="margin-bottom:10px"><span style="font-size:18px;margin-right: 20px;">评估时间</span>
                    ...
                    <el-table ref="multipleTable" :data="tableData1" @selection-change="selectchange1" tooltip-effect="dark" style="width: 100%" :header-cell-style="{background:'#EBE0D8',color:'#000000'}">
                      ...
                      <el-table-column prop="standard" label="评估时间">
                      </el-table-column>
                  ...
                  <el-tab-pane label="待完成评估" name="second">
                    ...
                    <el-table ref="multipleTable" :data="tableData2" @selection-change="selectchange2" tooltip-effect="dark" style="width: 100%" :header-cell-style="{background:'#EBE0D8',color:'#000000'}">
                      ...
                      <el-table-column prop="standard" label="现阶段剩余评估">
                      </el-table-column>
                      <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                          <el-button type="text" style="color: #F49B4D;" size="mini" @click="handleWatch(scope.row)">开始评估</el-button>
  ...
  <script>
import { getAllAssess, getAssessByDate } from '@/api/doctor'
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      getAllAssess(obj).then(res => {
        if (res.code == 200) {
          res.data.json_assessed = this.tableData1
          res.data.json_notassess = this.tableData2
        }
      })
    },
    // 点击选项卡处理事件
