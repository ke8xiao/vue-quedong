                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                  ...
                  <el-tab-pane label="客观评估" name="second">
                    <el-table ref="multipleTable" :data="tableData2" @selection-change="selectchange2" tooltip-effect="dark" style="width: 100%" :header-cell-style="{background:'#EBE0D8',color:'#000000'}">
                      ...
                      <el-table-column prop="standard" label="评估值">
                      </el-table-column>
                    </el-table>
                  </el-tab-pane>
                  ...
                  <el-tab-pane label="评估小节" name="fifth">
                    <el-input type="textarea" :autosize="{ minRows: 10, maxRows: 30}" placeholder="该患者.....建议....." v-model="textarea">
                    </el-input>
                  </el-tab-pane>
                </el-tabs>
              </span>
